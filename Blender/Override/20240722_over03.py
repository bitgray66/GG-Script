...
# Funzione per ottenere la lista degli oggetti selezionati e le loro posizioni
def get_list_selected():
    try:
        # Ottieni gli oggetti selezionati nel contesto attuale
...
# Funzione per creare un override delle collezioni degli oggetti selezionati
...
# Funzione per ottenere una lista di prefissi degli oggetti selezionati
...
# Funzione per riselezionare gli oggetti in base ai prefissi
...
# Funzione per creare un override degli oggetti selezionati
...
# Funzione per riposizionare gli oggetti in base ai prefissi e alle nuove posizioni
            ...
            for key in prefix_location:
                ...
                if ob_name.startswith(key):
                    ...
                    if obj:
                        ...
                        try:
                            # Converti la stringa 'val' in una tupla
...
# Esegui la funzione principale con blocchi try-except
try:
    # Ottieni gli oggetti selezionati e le loro posizioni
    ...
    # Converti le posizioni degli oggetti in stringhe
    list_position = []
    ...
    # Esegui override delle collezioni
    override_collections(selected_col)

    # Ottieni i prefissi degli oggetti selezionati
    list_prefixes = get_list_prefixes(selected_col)
    print("return_list_prefixes ------------> ", list_prefixes)

    # Riseleziona gli oggetti in base ai prefissi
    reselect_objects(list_prefixes)
    print("reselect_objects ------------> OK")

    # Esegui override degli oggetti selezionati
    override_selected_object()

    # Crea un dizionario di prefissi e nuove posizioni
    ...
    # Riposiziona gli oggetti in base ai prefissi e alle nuove posizioni
