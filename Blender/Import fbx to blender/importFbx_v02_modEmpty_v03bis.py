            ...
            for root, dirs, files in os.walk(folder_path):
                for file in files:
                    ...
                    if file.lower().endswith(".fbx"):
                        ...
                        def find_textures(asset_name, texture_folder):
                            # Lista dei suffissi 
                        ...
                        def create_asset_material(asset_name):

                            # Elimina materiali esistenti
                            for mat in bpy.data.materials:
                                print('elimino -->', mat)
                                bpy.data.materials.remove(mat)

                            matching_textures = find_textures(asset_name, texture_folder)


                            # Nome del materiale
                            material_name = asset_name+'_MAT'
                            ...
                            print("File trovati per '{}':".format(asset_name))
                            ...
                            bpy.data.materials[material_name].node_tree.nodes["Principled BSDF"].label = material_name
                        ...
                        mat = create_asset_material(asset_name)
