...
def create_asset_material(asset_name, asset_folder):
    ...
    def find_textures(folder_asset):
        first_letter = asset_name[7].upper()  # Estrai la prima lettera dell'asset e convertila in maiuscolo
        print('first_letter =', first_letter)
        texture_folder = os.path.join(asset_folder, first_letter, folder_asset, "Tx", "hi")
    ...
    principled_bsdf = material.node_tree.nodes.new(name=asset_name + "_mat")
